...
Defined in: [packages/oidc/src/get-vercel-oidc-token-with-refresh.ts:96](https://github.com/yuhb1975/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-with-refresh.ts#L96)
