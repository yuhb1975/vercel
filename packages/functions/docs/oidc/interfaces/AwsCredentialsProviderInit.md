...
Defined in: [packages/functions/src/oidc/aws-credentials-provider.ts:20](https://github.com/yuhb1975/vercel/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L20)
