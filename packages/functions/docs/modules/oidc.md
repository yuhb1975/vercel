...
[packages/functions/src/oidc/aws-credentials-provider.ts:70](https://github.com/yuhb1975/vercel/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L70)
